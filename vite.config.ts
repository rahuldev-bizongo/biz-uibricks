  ...
  build: {
    rollupOptions: {
      input: {
        ...
        ContainerRow: path.resolve(__dirname, "src/lib/components/ContainerRow.jsx"),
        ...
        SpecialCard: path.resolve(__dirname, "src/lib/components/SpecialCard.jsx"),
        Stepper: path.resolve(__dirname, "src/lib/components/Stepper.jsx"),
        Text: path.resolve(__dirname, "src/lib/components/Text.jsx"),
        ComponentRegistry: path.resolve(__dirname, "src/lib/registry/ComponentRegistry.ts"),
      },
      output: {
